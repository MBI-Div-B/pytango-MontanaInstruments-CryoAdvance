...
class CryoAdvance(genericcryostat.GenericCryostat):
    ...
    def set_platform_temperature(self, target):
        if target < 20:
            self.set_prop('/controller/properties/cryocoolerSpeedMode', 'High')
        else:
            self.set_prop('/controller/properties/cryocoolerSpeedMode', 'Auto')
    ...
    def get_platform_temperature(self):
        ...
        r = round(r['sample']['temperatureAvg1Sec'],3)
        return r

    def get_platform_temperature_rate(self):
        r1 = self.get_prop('/sampleChamber/temperatureControllers/platform/thermometer/properties/sample')['sample']['temperatureAvg1Sec']
        time.sleep(0.1)
        r2 = self.get_prop('/sampleChamber/temperatureControllers/platform/thermometer/properties/sample')['sample']['temperatureAvg1Sec']
        return round(600*(r2-r1),3)

    def get_platform_temperature_stability(self):
        r = self.get_prop('/sampleChamber/temperatureControllers/platform/thermometer/properties/sample')
        return r['sample']['temperatureStable'], r['sample']['temperatureStability']

    #
    # Sample temperature methods
    #
    ...
    def get_sample_temperature_rate(self):
        r1 = self.get_prop('/sampleChamber/temperatureControllers/user1/thermometer/properties/sample')['sample']['temperatureAvg1Sec']
        time.sleep(0.1)
        r2 = self.get_prop('/sampleChamber/temperatureControllers/user1/thermometer/properties/sample')['sample']['temperatureAvg1Sec']
        return round(600*(r2-r1),3)

    def get_sample_temperature_stability(self):
        r = self.get_prop('/sampleChamber/temperatureControllers/user1/thermometer/properties/sample')
        return r['sample']['temperatureStable'], r['sample']['temperatureStability']
